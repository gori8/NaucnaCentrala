...
@NoArgsConstructor
public class NacinPlacanjaMultiSelectionFormType extends AbstractFormFieldType {

    public static final String TYPE_NAME = "first-multi-select";
    protected Map<Long, String> values=new HashMap<>();

    public NacinPlacanjaMultiSelectionFormType(Map<Long, String> values) {
        this.values = values;
    }
