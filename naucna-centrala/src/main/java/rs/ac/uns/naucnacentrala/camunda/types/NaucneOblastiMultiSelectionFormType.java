...
@NoArgsConstructor
public class NaucneOblastiMultiSelectionFormType extends AbstractFormFieldType {

    public static final String TYPE_NAME = "second-multi-select";
    protected Map<Long, String> values=new HashMap<>();

    public NaucneOblastiMultiSelectionFormType(Map<Long, String> values) {
        this.values = values;
    }
